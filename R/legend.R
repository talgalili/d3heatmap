...
#' @param title \emph{Optional, character} Separate title for legend. Defaults to \code{NULL}.
#' @param location \emph{Required, character} Location for legend, either \code{"fl", "br", "tr"
...
hmLegend <- function(
  ...
  if(missing(heatmap)) stop("hmLegend: no heatmap provided")
